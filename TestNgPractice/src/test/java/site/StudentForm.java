...
public class StudentForm {
	...
	public void name() throws Throwable {
		...
		Assert.assertEquals(driver.findElement(By.xpath("//input[@id='name']")).getAttribute("value"), resultSet.getString("name"));
	...
	public void email() throws Throwable {
		...
		Assert.assertEquals(driver.findElement(By.xpath("//input[@id='email']")).getAttribute("value"), resultSet.getString("email"));
	}
	...
	public void mobileNumber() throws Throwable {
		...
		Assert.assertEquals(driver.findElement(By.xpath("//input[@id='mobile']")).getAttribute("value"), resultSet.getString("mobileNumber"));
	}
	...
	public void Fetch_database_date_to_Webpage() throws Throwable {
		...
		System.out.println("Date fetch successfully..... ! ");
	...
	public void subject() throws Throwable {
		...
		Assert.assertEquals(driver.findElement(By.xpath("//input[@id='subjects']")).getAttribute("value"), resultSet.getString("subject"));
	}
	...
	public void currentAddress() throws Throwable {
		...
		Assert.assertEquals(driver.findElement(By.xpath("//textarea[@id='picture']")).getAttribute("value"), resultSet.getString("currentAddress"));
